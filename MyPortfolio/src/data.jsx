...
export const resume = [
	{
		...
		desc2: "Main responsibilities included building website templates using ACF and WordPress, as well as developing web applications primarily with Vue, Nuxt 3, Tailwind CSS, and Nuxt UI.",
	},
	{
		id: 2,
		category: "experience",
		...
		desc2: "My main task was to completely change the appearance of the program based on the previously designed design, adjust the appearance to mobile devices. Additionally I introduced new functionalities in the program.",
	},
	{
		id: 1,
		category: "experience",
		...
		desc2: "My main task was to create websites, online stores, and templates for the WordPress CMS. For website development, I primarily used HTML, SCSS, JavaScript, PHP, WordPress + ACF. I also worked with WooCommerce and Shoper online stores.",
	},
]
		...
		details: [
			{
				icon: <FiFileText />,
				title: "Project : ",
				desc: "Professional Wordpress Template",
			},
			{
				icon: <FiUser />,
				title: "Client : ",
			...
			},
			{
				icon: <FaCode />,
				title: "Language : ",
				desc: "Wordpress, Sage, Tailwind, Gutenberg Native Blocks",
			},
			{
				icon: <FiExternalLink />,
				title: "Preview : ",
